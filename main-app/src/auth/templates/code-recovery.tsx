      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Text style={text}>
              Мы получили запрос на восстановление пароля. Используйте код ниже для восстановления
              пароля:
            </Text>
            ...
            <Section style={warningBox}>
              ...
              <Text style={warningText}>
                Этот код действителен в течение {expirationMinutes} минут ({expirationDate}). Если
                вы не запрашивали восстановление пароля, пожалуйста, проигнорируйте это письмо и
                рассмотрите возможность смены пароля.
              </Text>
            </Section>
